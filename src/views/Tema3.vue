  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .tarjeta.tarjeta-zul.p-4.mb-4
      PasosB.color-secundario
        ...
        .row.align-items-center.justify-content-center(titulo="Definir el grupo objetivo")
          .col-lg-8.col-md-12.mb-4.mb-md-0
            .row.justify-content-center
              .col-md-11
                .tarjeta.color-azul2.p-5.mb-4 
                  h4 Definir el grupo objetivo
        ...
        .row.align-items-center.justify-content-center(titulo="Análisis de la competencia")
          .col-lg-8.col-md-12.mb-4.mb-md-0
            .row.justify-content-center
              .col-md-11
                .tarjeta.color-azul2.p-5.mb-4 
        ...
        .row.align-items-center.justify-content-center(titulo="Perfil de enlaces")
          .col-lg-8.col-md-12.mb-4.mb-md-0
            .row.justify-content-center
              .col-md-11
                .tarjeta.color-azul2.p-5.mb-4 
                  h4 Perfil de enlaces
        ...
        .row.align-items-center.justify-content-center(titulo="Definir títulos")
          .col-lg-8.col-md-12.mb-4.mb-md-0
            .row.justify-content-center
              .col-md-11
                .tarjeta.color-azul2.p-5.mb-4
        ...
        .row.align-items-center.justify-content-center(titulo="Vincula la palabra clave al inicio de un artículo")
          .col-lg-8.col-md-12.mb-4.mb-md-0
            .row.justify-content-center
              .col-md-11
                .tarjeta.color-azul2.p-5.mb-4
                  h4 Vincula la palabra clave al inicio de un artículo
        ...
        .row.align-items-center.justify-content-center(titulo="Optimización de carga")
          .col-lg-8.col-md-12.mb-4.mb-md-0
            .row.justify-content-center
              .col-md-11
                .tarjeta.color-azul2.p-5.mb-4
        ...
        .row.align-items-center.justify-content-center(titulo="Implementar Google Analytics")
          .col-lg-8.col-md-12.mb-4.mb-md-0
            .row.justify-content-center
              .col-md-11
                .tarjeta.color-azul2.p-5.mb-4
        ...
        .row.align-items-center.justify-content-center(titulo="Ordenar la jerarquía de la web")
          .col-lg-8.col-md-12.mb-4.mb-md-0
            .row.justify-content-center
              .col-md-11
                .tarjeta.color-azul2.p-5.mb-4
                  h4 Ordenar la jerarquía de la <i>web</i>
        ...
        .row.align-items-center.justify-content-center(titulo="Construye URL´s amigables")
          .col-lg-8.col-md-12.mb-4.mb-md-0
            .row.justify-content-center
              .col-md-11
                .tarjeta.color-azul2.p-5.mb-4
        ...
        .col-md-10
          SlyderF(columnas="col-lg-6 col-xl-4")
            ...
            .tarjeta.color-secundario.p-4
              h5 Anuncio de texto 
              p Hace referencia a la clase de anuncio estándar que se muestra en los buscadores, regularmente su estructura la componen: Un título, dos párrafos de texto y un enlace propio.

            .tarjeta.color-secundario.p-4
              h5 Conjunto de anuncios 
              p Como su palabra lo indica es un conjunto de anuncios y palabras clave, cuyo objetivo es reunir anuncios con el fin de organizar inversiones diarias, y segmentar los lugares, países donde se realizará la pauta de los anuncios.
            ...
            .tarjeta.color-secundario.p-4
              h5 Impresiones
              p Es la cantidad de veces que se ha visualizado un anuncio.

            .tarjeta.color-secundario.p-4
              h5 Clics 
              p Es la cantidad de clics que se realizan en un anuncio. 

            .tarjeta.color-secundario.p-4
              h5 CTR
              p Porcentajes de impresiones que producen un clic.

            .tarjeta.color-secundario.p-4
              h5 CPC
              p Hace referencia a costos por clic, es la forma de cobro de anuncios pagados realizados.
